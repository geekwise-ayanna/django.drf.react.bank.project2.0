                ...
                <Row className={css(styles.mainContainer)} breakpoints={{ 768: css(styles.mainContainerMobile, expanded && styles.mainContainerExpanded) }}>
                    ...
                    <Column className={css(styles.container)} breakpoints={{ 768: css(styles.containerMobile, expanded ? styles.show : styles.hide) }}>
                        ...
                        <Column className={css(styles.menuItemList)}>
                            <MenuItemComponent
                                title="Home" icon={IconOverview}
                                onClick={() => this.onItemClicked('Home')}
                                active={this.props.selectedItem === 'Home'}
                            />
                            <MenuItemComponent
                                title="Accounts" icon={IconAgents}
                                onClick={() => this.onItemClicked('Accounts')}
                                active={this.props.selectedItem === 'Accounts'} />
                            <MenuItemComponent
                                title="Customers" icon={IconContacts}
                                onClick={() => this.onItemClicked('Customers')}
                                active={this.props.selectedItem === 'Customers'} />
                            <MenuItemComponent
                                title="Branches" icon={IconTickets}
                                onClick={() => this.onItemClicked('Branches')}
                                active={this.props.selectedItem === 'Branches'}
                            />
                            <MenuItemComponent
                            ...
                            <MenuItemComponent
                                title="Login or Sign Up" icon={IconSubscription}
                                onClick={() => this.onItemClicked('Login or Sign Up')}
                                active={this.props.selectedItem === 'Login or Sign Up'} />
                        </Column>
                    </Column>
